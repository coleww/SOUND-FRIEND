...
(reset! vox  (fn[note idx]
              ...
              ; (if (= (mod idx 2) 0) (sill/play (+ note 0)))
...
(reset! baze (fn  [note idx]
               (tb303 :note (-  note 12)  :amp 0.5 :cutoff (get [2000 1000 8000 5000] (mod idx 4)) :attack 0.135 :release 0.15)
               (tb303 :note (-  note 24) :amp 0.5 :cutoff (get [1700 2000 9000 9000] (mod idx 4)) :attack 0.125 :release 0.15)))
(ctl mooger :amp 0.7 :attack 0.1 )
(mooger)
(reset! hevvy (fn  [note idx]

                (ctl mooger :note (+ note 0))
                )
        )

(reset! ambnt (fn  [note idx])
        )
...
(reset! tommy (fn  [idx]
                (tom :freq (rand-nth [1000 1200 1500 900 700 300]) :amp 0.79 )))
